...
<form
    ...
    <div class="form-group">
        ...
        <div class="center"><label>Điền thông tin ngoại ngữ</label></div>
            <label>Word</label>
            <input type="text" enable="false" class="form-control" name="wordname" id="wordname" value=""></>
            <label>Meaning</label>
            <input type="text" class="form-control" name="wordmeaning" id="wordmeaning" value=""></>
            <label>Type</label>
            <select class="form-control" name="type" id="type" onchange="onval()" >
...
<script type="text/javascript">
  function onval(){
      let sl = document.getElementById("moneycode");
      let slt = sl.options[sl.selectedIndex].text;
      document.getElementById("moneyname").value = slt;
  }
</script>
<!-- END: main -->
